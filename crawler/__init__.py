...
def download_image(url: str, filename: str):
    ...
    save_path = path.join('static/images', filename)
...
def get_illust_url(soup: BeautifulSoup):
...
def get_support_card(uri: str, soup: BeautifulSoup):
    ...
    image_filename = illust_uri.split('/')[-1]
    download_image(illust_uri, image_filename)
